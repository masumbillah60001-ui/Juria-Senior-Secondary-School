        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Manage academic departments and faculties.</p>
                </div>
                <Link
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="text-xs text-gray-500 uppercase bg-gray-50 border-b border-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-3 font-medium">Established</th>
                                ...
                                departments.map((dept) => (
                                    <tr key={dept._id} className="hover:bg-gray-50/50 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    {dept.description && (
                                                        <p className="text-xs text-gray-500 max-w-xs truncate">{dept.description}</p>
                                                    )}
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-gray-900">
                                            {typeof dept.hod === 'object' && dept.hod ? (
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${dept.isActive
